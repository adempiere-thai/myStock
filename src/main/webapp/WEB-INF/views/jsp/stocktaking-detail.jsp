...
<body>
	<div id="stocktaking-detail" data-role="page" data-theme="a">
		...
		<div data-role="popup" id="editQtyDialog" data-theme="a" data-overlay-theme="b" class="ui-corner-all" data-dismissible="false" style="width:260px;">
			<form id="editQtyFrm" novalidate="novalidate" data-ajax="false" action="${pageContext.request.contextPath}/stocktaking/detail/edit" method="POST">
		...
		<div data-role="popup" id="deleteDialog" data-theme="none" data-overlay-theme="b" data-transition="slideup" data-position-to="#step-block" data-dismissible="false" style="width:260px;">
			<form  id="deleteFrm" novalidate="novalidate" data-ajax="false" action="${pageContext.request.contextPath}/stocktaking/detail/delete" method="POST">
